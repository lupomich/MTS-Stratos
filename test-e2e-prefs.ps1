...
if (($reloaded.preferences.ui_settings.theme -eq 'dark') -and 
    ($reloaded.preferences.ui_settings.language -eq 'en') -and
    ($reloaded.preferences.ui_settings.gridLayout -eq 'comfortable')) {
